...
#define block_N 8
#define block_K 8
__global__ void matmul_gpu3(DATATYPE *a, DATATYPE *b, DATATYPE *c, int m, int n, int k)
{
...
{
  matmul_gpu3<<<grid, block, (block_M + block_N) * sizeof(DATATYPE) * block_K>>>(dev_a, dev_b, dev_c, m, n, k);
}
